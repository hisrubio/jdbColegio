...
public class AsignaturaController implements Serializable {
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
     ...
     public SelectItem[] getAsignaturasPropio() {
        return JsfUtil.getSelectItemsAsignaturas(ejbFacade.findAll(), true);
    }
    ...
    @FacesConverter(forClass = Asignatura.class, value="AsignaturasConverter")
