...
public class ProfesorController implements Serializable {
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
     ...
     public SelectItem[] getProfesoresPropio() {
        return JsfUtil.getSelectItemsProfesor(ejbFacade.findAll(), true);
    }
    ...
    @FacesConverter(forClass = Profesor.class, value="ProfesoresConverter")
